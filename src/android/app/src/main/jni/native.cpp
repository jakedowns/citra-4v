...
static jobject ToJavaCoreError(Core::System::ResultStatus result) {
    ...
    return env->GetStaticObjectField(
        core_error_class, env->GetStaticFieldID(core_error_class, name,
                                                "Lorg/citra/citra_1leia/NativeLibrary$CoreError;"));
}
...
void Java_org_citra_citra_1leia_NativeLibrary_SurfaceChanged(JNIEnv* env,
...
void Java_org_citra_citra_1leia_NativeLibrary_SurfaceDestroyed(JNIEnv* env,
                                                              [[maybe_unused]] jclass clazz) {
...
void Java_org_citra_citra_1leia_NativeLibrary_DoFrame(JNIEnv* env, [[maybe_unused]] jclass clazz) {
...
void Java_org_citra_citra_1leia_NativeLibrary_NotifyOrientationChange(JNIEnv* env,
                                                                     [[maybe_unused]] jclass clazz,
                                                                     jint layout_option,
                                                                     jint rotation) {
...
void Java_org_citra_citra_1leia_NativeLibrary_SwapScreens(JNIEnv* env, [[maybe_unused]] jclass clazz,
...
void Java_org_citra_citra_1leia_NativeLibrary_SetUserDirectory(JNIEnv* env,
                                                              [[maybe_unused]] jclass clazz,
                                                              jstring j_directory) {
    FileUtil::SetCurrentDir(GetJString(env, j_directory));
}

jobjectArray Java_org_citra_citra_1leia_NativeLibrary_GetInstalledGamePaths(
...
void Java_org_citra_citra_1leia_NativeLibrary_UnPauseEmulation(JNIEnv* env,
                                                              [[maybe_unused]] jclass clazz) {
    pause_emulation = false;
...
void Java_org_citra_citra_1leia_NativeLibrary_PauseEmulation(JNIEnv* env,
                                                            [[maybe_unused]] jclass clazz) {
    pause_emulation = true;
    InputManager::NDKMotionHandler()->DisableSensors();
}

void Java_org_citra_citra_1leia_NativeLibrary_StopEmulation(JNIEnv* env,
                                                           [[maybe_unused]] jclass clazz) {
    stop_run = true;
    pause_emulation = false;
...
jboolean Java_org_citra_citra_1leia_NativeLibrary_IsRunning(JNIEnv* env,
                                                           [[maybe_unused]] jclass clazz) {
    return static_cast<jboolean>(!stop_run);
}

jboolean Java_org_citra_citra_1leia_NativeLibrary_onGamePadEvent(JNIEnv* env,
                                                                [[maybe_unused]] jclass clazz,
...
jboolean Java_org_citra_citra_1leia_NativeLibrary_onGamePadMoveEvent(JNIEnv* env,
                                                                    [[maybe_unused]] jclass clazz,
...
jboolean Java_org_citra_citra_1leia_NativeLibrary_onGamePadAxisEvent(JNIEnv* env,
                                                                    [[maybe_unused]] jclass clazz,
...
jboolean Java_org_citra_citra_1leia_NativeLibrary_onTouchEvent(JNIEnv* env,
                                                              [[maybe_unused]] jclass clazz,
                                                              jfloat x, jfloat y,
                                                              jboolean pressed) {
    return static_cast<jboolean>(
...
void Java_org_citra_citra_1leia_NativeLibrary_onTouchMoved(JNIEnv* env,
                                                          [[maybe_unused]] jclass clazz, jfloat x,
                                                          jfloat y) {
    window->OnTouchMoved((int)x, (int)y);
}

jintArray Java_org_citra_citra_1leia_NativeLibrary_GetIcon(JNIEnv* env,
                                                          [[maybe_unused]] jclass clazz,
                                                          jstring j_file) {
...
jstring Java_org_citra_citra_1leia_NativeLibrary_GetTitle(JNIEnv* env, [[maybe_unused]] jclass clazz,
                                                         jstring j_filename) {
...
jstring Java_org_citra_citra_1leia_NativeLibrary_GetDescription(JNIEnv* env,
                                                               [[maybe_unused]] jclass clazz,
                                                               jstring j_filename) {
    return j_filename;
}

jstring Java_org_citra_citra_1leia_NativeLibrary_GetGameId(JNIEnv* env,
                                                          [[maybe_unused]] jclass clazz,
                                                          jstring j_filename) {
    return j_filename;
}

jstring Java_org_citra_citra_1leia_NativeLibrary_GetRegions(JNIEnv* env,
                                                           [[maybe_unused]] jclass clazz,
                                                           jstring j_filename) {
    std::string filepath = GetJString(env, j_filename);
...
jstring Java_org_citra_citra_1leia_NativeLibrary_GetCompany(JNIEnv* env,
                                                           [[maybe_unused]] jclass clazz,
                                                           jstring j_filename) {
    std::string filepath = GetJString(env, j_filename);
...
jstring Java_org_citra_citra_1leia_NativeLibrary_GetGitRevision(JNIEnv* env,
                                                               [[maybe_unused]] jclass clazz) {
    return nullptr;
}

void Java_org_citra_citra_1leia_NativeLibrary_CreateConfigFile(JNIEnv* env,
                                                              [[maybe_unused]] jclass clazz) {
    Config{};
}

jint Java_org_citra_citra_1leia_NativeLibrary_DefaultCPUCore(JNIEnv* env,
                                                            [[maybe_unused]] jclass clazz) {
    return 0;
}

void Java_org_citra_citra_1leia_NativeLibrary_Run__Ljava_lang_String_2Ljava_lang_String_2Z(
    JNIEnv* env, [[maybe_unused]] jclass clazz, jstring j_file, jstring j_savestate,
    jboolean j_delete_savestate) {}

void Java_org_citra_citra_1leia_NativeLibrary_ReloadSettings(JNIEnv* env,
                                                            [[maybe_unused]] jclass clazz) {
    Config{};
    Core::System& system{Core::System::GetInstance()};
...
jstring Java_org_citra_citra_1leia_NativeLibrary_GetUserSetting(JNIEnv* env,
                                                               [[maybe_unused]] jclass clazz,
...
void Java_org_citra_citra_1leia_NativeLibrary_SetUserSetting(JNIEnv* env,
                                                            [[maybe_unused]] jclass clazz,
                                                            jstring j_game_id, jstring j_section,
...
void Java_org_citra_citra_1leia_NativeLibrary_InitGameIni(JNIEnv* env, [[maybe_unused]] jclass clazz,
                                                         jstring j_game_id) {
    std::string_view game_id = env->GetStringUTFChars(j_game_id, 0);
...
jdoubleArray Java_org_citra_citra_1leia_NativeLibrary_GetPerfStats(JNIEnv* env,
                                                                  [[maybe_unused]] jclass clazz) {
...
void Java_org_citra_citra_1leia_utils_DirectoryInitialization_SetSysDirectory(
...
void Java_org_citra_citra_1leia_NativeLibrary_Run__Ljava_lang_String_2(JNIEnv* env,
                                                                      [[maybe_unused]] jclass clazz,
                                                                      jstring j_path) {
...
jobjectArray Java_org_citra_citra_1leia_NativeLibrary_GetTextureFilterNames(JNIEnv* env,
                                                                           jclass clazz) {
...
void Java_org_citra_citra_1leia_NativeLibrary_ReloadCameraDevices(JNIEnv* env, jclass clazz) {
    if (g_ndk_factory) {
        g_ndk_factory->ReloadCameraDevices();
    }
}

jboolean Java_org_citra_citra_1leia_NativeLibrary_LoadAmiibo(JNIEnv* env, jclass clazz,
                                                            jbyteArray bytes) {
    Core::System& system{Core::System::GetInstance()};
...
void Java_org_citra_citra_1leia_NativeLibrary_RemoveAmiibo(JNIEnv* env, jclass clazz) {
    Core::System& system{Core::System::GetInstance()};
    Service::SM::ServiceManager& sm = system.ServiceManager();
    auto nfc = sm.GetService<Service::NFC::Module::Interface>("nfc:u");
    if (nfc == nullptr) {
...
void Java_org_citra_citra_1leia_NativeLibrary_InstallCIAS(JNIEnv* env, [[maybe_unused]] jclass clazz,
                                                         jobjectArray path) {
...
jobjectArray Java_org_citra_citra_1leia_NativeLibrary_GetSavestateInfo(
    JNIEnv* env, [[maybe_unused]] jclass clazz) {
...
void Java_org_citra_citra_1leia_NativeLibrary_SaveState(JNIEnv* env, jclass clazz, jint slot) {
    Core::System::GetInstance().SendSignal(Core::System::Signal::Save, slot);
}

void Java_org_citra_citra_1leia_NativeLibrary_LoadState(JNIEnv* env, jclass clazz, jint slot) {
